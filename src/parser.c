...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_LBRACK_LBRACK] = "symbol",
  [anon_sym_RBRACK_RBRACK] = "symbol",
  ...
  [anon_sym_LBRACE_DASH] = "symbol",
  [anon_sym_LBRACE_TILDE] = "symbol",
  [anon_sym_LBRACE_POUND] = "symbol",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [anon_sym_RBRACK_RBRACK] = anon_sym_LBRACK_LBRACK,
  [anon_sym_LBRACK] = anon_sym_LBRACK_LBRACK,
  [anon_sym_RBRACK] = anon_sym_LBRACK_LBRACK,
  [sym_tag] = sym_tag,
